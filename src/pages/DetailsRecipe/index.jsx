    ...
    return (
        <div className='DetailsRecipe'>
            ...
            <div className='DetailsRecipe-header'>
                <h2  onClick={goToHomePage} className='DetailsRecipe-header--title'>Livro de receitas</h2>
            ...
            <div className='DetailsRecipe-content'>
                <div>
                    <div className='DetailsRecipe-content--actions'>
                        ...
                        <div className='DetailsRecipe-content--icons'>
                            <img className='icon' onClick={() => editRecipe(recipe.id)} src={EditIcon} />
                            <img className='icon' onClick={() => deleteRecipe(recipe.id)} src={DeleteIcon} />
                        </div>
                    </div>
                ...
                <img className='DetailsRecipe-content--image' src={recipe.imageUrl || defaultImage[recipe.category]} />
